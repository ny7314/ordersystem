<x-app-layout>
  ...
  <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">md:
                  ...
                  <section class="text-gray-600 body-font">
                    <div class="container md:px-5 mx-auto">
                      ...
                      <div class="flex justify-end mb-4">
                        <button onclick="location.href='{{ route('admin.owners.create') }}'" class="text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">新規登録</button>
                      </div>
                      <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                        <table class="table-auto w-full text-left whitespace-no-wrap">
                          <thead>
                            <tr>
                              <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">葬儀社名</th>
                        ...
                        {{ $owners->links() }}
                      </div>{{-- <enddiv>"lg:w-2/3 w-full mx-auto overflow-auto" --}}
                    </div>
                  </section>
